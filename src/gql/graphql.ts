  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getMainCharacters' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  values: [
                    ...
                    { kind: 'IntValue', value: '4' },
                    { kind: 'IntValue', value: '5' }
                  ]
                }
              }
            ],
...
} as unknown as DocumentNode<GetMainCharactersQuery, GetMainCharactersQueryVariables>;
